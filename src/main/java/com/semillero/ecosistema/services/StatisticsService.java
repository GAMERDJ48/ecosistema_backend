...
public class StatisticsService {
    ...
    public ResponseEntity<StatisticsSupplierByStatusDto> getStatisticsSupplierByStatus(){
        ...
        statisticsDto.setNewSuppliers(supplierService.findAllSupplier().size());
    ...
    public List<StatisticsViewByPublicationDto> getPublicationByViews(){
        List<PublicationModel> publicationModelList = publicationRepository.findAllByOrderByQuantityViewsDesc();
