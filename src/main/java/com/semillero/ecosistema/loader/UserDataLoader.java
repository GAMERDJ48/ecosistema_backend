...
public class UserDataLoader implements CommandLineRunner {
    ...
    public void loadUserData(String... args) throws Exception {
        if (userRepository.count() == 0) {
            ...
            users.add(new UserModel("Federico", "Higa", "higamaradonafederico@gmail.com", false, Role.ADMINISTRADOR, "1553665585"));
            ...
            users.add(new UserModel("Rancho", "Ranchez", "ranchoranchez@gmail.com", false, Role.ADMINISTRADOR, "1553665585"));
            users.add(new UserModel("Lautaro", "Croce", "croce.tato30@gmail.com", false, Role.ADMINISTRADOR, "1553665585"));
            users.add(new UserModel("Lautaro", "Croce", "croce.tato31@gmail.com", false, Role.ADMINISTRADOR, "1553665585"));
